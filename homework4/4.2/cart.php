...
<table style="width:100%">
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
          <a class="btn btn-primary" href="addProduct.php?id=<?php echo $value['ID'] ?>">+</a>
          <?php echo $value['COUNT']; ?>
           <a class="btn btn-primary" href="reduction.php?id=<?php echo $value['ID'] ?>">-</a>
        </td>
      ...
      <td bgcolor="#E75621"><b>Tổng tiền</b></td>
      <td bgcolor="#E75621"><b><?php echo $sum;?></b></td>
    </tr>
