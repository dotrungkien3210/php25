          ...
          <div class="top-bar-list">
                      ...
                      <div class="list-group list-group-flush list-group-reflow mb-2">
                        ...
                        <div class="list-group-item py-2">
                          ...
                          <div class="user-avatar user-avatar-sm bg-muted">
                            <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/bootstrap.svg" alt="">
                          </div>
                          <div class="ml-2">
                        ...
                        <div class="list-group-item py-2">
                          <a href="#" class="stretched-link"><span class="sr-only">Go to search result</span></a>
                          <div class="user-avatar user-avatar-sm bg-muted">
                            <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/slack.svg" alt="">
                          </div>
                          <div class="ml-2">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces15.jpg" alt="">
                        </div>
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces16.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces17.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces18.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces19.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces20.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/uifaces21.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                ...
                <li class="nav-item dropdown header-nav-dropdown has-notified">
                  ...
                  <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/team1.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/team3.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/team2.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
              ...
              <div class="dropdown d-none d-md-flex">
                <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/profile.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> <!-- .dropdown-menu -->
      ...
      <aside class="app-aside app-aside-expand-md app-aside-light">
        ...
        <div class="aside-content">
          ...
          <header class="aside-header d-block d-md-none">
            <!-- .btn-account -->
            <button class="btn-account" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span class="user-avatar user-avatar-lg"><img src="<?php echo URL_TEMPLATE_ADMIN?>/assets/images/avatars/profile.jpg" alt=""></span> <span class="account-icon"><span class="fa fa-caret-down fa-lg"></span></span> <span class="account-summary"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> <!-- /.btn-account -->
            <!-- .dropdown-aside -->
